...
pub(super) fn routes() -> Router<ServerState> {
    Router::new()
        ...
        .route("/api/projects/{project_id}/conversations/{conversation_id}/tasks/{task_id}/schema-retry-preview", get(super::conversation_schema::retry_preview))
        .route("/api/projects/{project_id}/conversations/{conversation_id}/tasks/{task_id}/schema-retries", post(super::conversation_schema::retry))
        .route("/api/projects/{project_id}/conversations/{conversation_id}/tasks/{task_id}/schema-retries/{call_id}", get(super::conversation_schema::retry_receipt))
