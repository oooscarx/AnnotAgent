...
export const api = {
  ...
  cancelConversationSchema: (project: string, conversation: string, task: string, call: string) => request<import("./types").ConversationCallReceipt>(`/api/projects/${encodeURIComponent(project)}/conversations/${encodeURIComponent(conversation)}/tasks/${encodeURIComponent(task)}/calls/${encodeURIComponent(call)}/cancel`, { method: "POST" }),
