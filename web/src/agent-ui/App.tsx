                  ...
                  <div className="thread">
                    {!task.items.length ? (
                      <div className="welcome">
                        ...
                        {!fixture && adapter.demoOnboarding && <DemoOnboarding service={adapter.demoOnboarding} onStarted={openDemoReceipt}/>}
                      </div>
                    ) : (
                      <>
                        {task.items.map((item) => (
