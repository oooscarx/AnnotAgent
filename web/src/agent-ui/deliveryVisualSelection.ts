...
export type VisualSelection = {
  ...
  source:
    | {kind:"sample";draft_id:string;draft_revision:number;sample_test_id:string;source_artifact_id:string|null}
...
export function sampleVisualSelection(result:DeliverySampleResult,imageId:string,annotation?:Annotation):VisualSelection {
  ...
  return {project_id:result.project_id,task_id:result.task_id,image_id:imageId,annotation_id:annotation?.id||null,label:annotation?.label||null,
