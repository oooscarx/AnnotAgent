    ...
    <div className={`app-shell ${focusLayout ? "focus-layout" : ""}`} data-layout={focusLayout ? "focus" : "management"}>
      ...
      >
        ...
        {loaded && route.kind === "conversation" && (
          selectedProject ? <ConversationWorkspace key={route.projectId} project={selectedProject} conversationId={route.conversationId} imageId={route.imageId} draftId={route.draftId} sampleTestId={route.sampleTestId} taskId={route.taskId} humanRequestId={route.humanRequestId} onNavigate={navigate} onNavigationGuardChange={setNavigationGuard} />
