          ...
          {groupItems.map((installation) => {
            ...
            return <article className="plugin-card" key={identity}>
              ...
              <div className="registry-card-actions">
                {!workflowReadyInstances.length && <button className="primary" onClick={() => openModelSetup(installation)} disabled={Boolean(busy) || installation.status === "unsupported_platform"}>Install compatible model</button>}
