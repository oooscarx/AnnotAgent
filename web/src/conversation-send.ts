...
export type SendCommand = { message: ConversationMessageInput; task_id: string | null; schema_revision: string; agent_model?:SendModel };
export type SendReceipt = { message: ConversationMessage; task_id: string; disposition: "new_task" | "task_message" | "candidate_feedback"; agent_model?:SendModel };
