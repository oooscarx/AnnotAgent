...
export type SendCommand = { message: ConversationMessageInput; task_id: string | null; schema_revision: string };
export type SendReceipt = { message: ConversationMessage; task_id: string; disposition: "new_task" | "task_message" | "candidate_feedback" };
