...
export function ConversationBuilderCard({ project, conversation, task, schema, editing }: {
  project: string; conversation: string; task: string; schema: ConversationSchemaDraft; editing: boolean;
}) {
