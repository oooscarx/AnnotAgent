...
export default defineConfig({
  testDir: "./e2e",
  testMatch: ["agent-ui-history.spec.ts", "agent-ui-http.spec.ts", "agent-ui-project-management.spec.ts", "agent-ui-delivery.spec.ts", "agent-ui-mainline-integration.spec.ts", "p0-autonomous-sample.spec.ts", "p0-diagnostic-scenes.spec.ts"],
  fullyParallel: false,
  workers: 1,
  timeout: 60_000,
  use: {
