...
- The Model Registry, capability checks, OpenAI-compatible/HTTP/mock/deterministic adapters, and
  external Worker contract are implemented. Settings can add/remove an arbitrary collection of
  versioned Detection Worker entries; general ONNX inference and model training are not bundled.
